...
export default function ClientEdit() {
  ...
  return (
    <AdminGuard>
    <Edit saveButtonProps={saveButtonProps} title="Editar Información del Cliente">
          ...
          <Col xs={24} lg={12}>
            ...
            >
              ...
              <Form.Item label="Dirección Comercial" name="address">
                <Input.TextArea rows={2} placeholder="Calle, Número, Localidad..." />
              </Form.Item>

              <Form.Item label="Notas Adicionales" name="notes">
                <Input.TextArea rows={2} placeholder="Observaciones internas sobre el cliente..." />
              </Form.Item>
            </Card>
          </Col>
        </Row>
