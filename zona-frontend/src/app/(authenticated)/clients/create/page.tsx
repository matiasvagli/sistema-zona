          ...
          <Space size={24}>
            ...
            <div>
              ...
              <Text style={{ color: "rgba(255,255,255,0.7)", fontSize: "15px" }}>
                Incorpore un nuevo contacto comercial al directorio central
              </Text>
            </div>
          </Space>
          ...
          <Row gutter={[32, 32]}>
            ...
            <Col xs={24} lg={12}>
              ...
              >
                ...
                >
                  <Input size="large" prefix={<UserOutlined style={{ color: "#0891b2" }} />} placeholder="Ej: Publicidad Exterior S.A." style={{ borderRadius: "10px" }} />
                </Form.Item>
                ...
                >
                  <Input size="large" prefix={<IdcardOutlined style={{ color: "#0891b2" }} />} placeholder="30-XXXXXXXX-X" style={{ borderRadius: "10px" }} />
                </Form.Item>
                    ...
                    <Checkbox>
                      <Space direction="vertical" size={0}>
                        ...
                        <Text type="secondary" style={{ fontSize: "12px" }}>
                          Habilita la creación de presupuestos y órdenes de trabajo.
                        </Text>
                      </Space>
                    </Checkbox>
                  </Form.Item>
